...
namespace ShuttleMate.Contract.Services.Interfaces
{
    public interface IScheduleService
    {
        ...
        Task<BasePaginatedList<ResponseScheduleModel>> GetAllByDriverIdAsync(Guid driverId, string from, string to, string? dayOfWeek, string? direction, bool sortAsc, int page = 0, int pageSize = 10);
        Task<BasePaginatedList<ResponseOldScheduleModel>> GetAllAsync(Guid routeId, string from, string to, string? direction, bool sortAsc, int page = 0, int pageSize = 10);
