        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastUpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeletedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LimitSalePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketPromotion", x => new { x.PromotionId, x.TicketId });
                    table.ForeignKey(
                        name: "FK_TicketPromotion_Promotions_PromotionId1",
                        column: x => x.PromotionId1,
                        principalTable: "Promotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketPromotion_TicketType_TicketTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TripDirection = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trips_Shuttles_ShuttleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartureTimes_RouteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StopEstimates_DepartureTimeId",
                table: "StopEstimates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketPromotion_PromotionId1",
                table: "TicketPromotion",
                column: "PromotionId1");

            migrationBuilder.CreateIndex(
                name: "IX_TicketPromotion_TicketTypeId",
                table: "TicketPromotion",
                column: "TicketTypeId");
